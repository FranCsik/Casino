...
public class FormBorrarMaquina extends JFrame {
		...
		public void actionPerformed(ActionEvent boton) {
			try {
				if(boton.getActionCommand() == "Aceptar") {
					...
					Casino.getInstancia().eliminarMaquina( idMaquina );
					listaMaquinas.removeItem( idMaquina );
					
				}
			}
			catch(NullPointerException e) {
				JOptionPane.showMessageDialog(ventana, "Seleccione una máquina");
			}
